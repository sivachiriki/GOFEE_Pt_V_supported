...
#gs3.tight_layout(fig, rect=[0.61, 0.1, 0.91, 0.6]) # (left, bottom, right, top)
############################################################################################
data = read(sys.argv[3]+'@:')
...
#gs3.tight_layout(fig, rect=[0.81, 0.1, 0.6, 0.6],h_pad=0.4,w_pad=0.4) # (left, bottom, right, top)
#############################################################################################
