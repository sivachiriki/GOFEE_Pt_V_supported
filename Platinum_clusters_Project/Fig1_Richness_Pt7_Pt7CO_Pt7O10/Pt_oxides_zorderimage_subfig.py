...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=142 ):
           colors[i] =[102/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 277 and i <=284 ):
           colors[i] =[102/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 419 and i <=426 ):
           colors[i] =[102/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 561 and i <=568 ):
           colors[i] =[102/255, 0/255, 0/255]
...
fig, ax = pyplot.subplots(nrows=2, ncols=5,figsize=(10,10))
