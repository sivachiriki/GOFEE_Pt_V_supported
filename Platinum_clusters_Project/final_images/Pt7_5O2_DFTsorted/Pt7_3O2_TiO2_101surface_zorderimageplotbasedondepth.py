...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=151 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 292 and i <=303 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 443 and i <=454 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 595 and i <=606 ):
           colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt7_5O2_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7_5O2_Al2O3_0001_DFTopt_g{}'.format(j)
