...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=147 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 292 and i <=294 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 439 and i <=441 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 586 and i <=588 ):
           colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt10_O2_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt10_O2_Al2O3_0001_DFTopt_g{}'.format(j)
