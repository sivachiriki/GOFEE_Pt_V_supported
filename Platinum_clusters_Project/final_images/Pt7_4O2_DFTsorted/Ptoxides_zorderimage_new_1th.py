...
for j in range(1,len(data)):
   ...
   # write('newimage.traj',atoms)
    ...
    atoms = data[j]*(3,3,1)
    a=atoms
    del atoms[atoms.positions[:,0] >=centreofmass[0]+11.50]
    del atoms[atoms.positions[:,0] <= centreofmass[0]-6.0]
    del atoms[atoms.positions[:,1] >= centreofmass[1]+8.50]
    ...
    ax.set_xlim([centreofmass[0]-5.50, centreofmass[0]+10.50])
    ...
    ax.set_xlim([centreofmass[0]-5.5, centreofmass[0]+10.50])
    ax.set_ylim([centreofmass[1]-6.3, centreofmass[1]+7.50])
