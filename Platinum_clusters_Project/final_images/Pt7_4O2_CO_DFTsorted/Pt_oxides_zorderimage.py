...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=152 ):
           colors[i] =[153/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 287 and i <=304 ):
           colors[i] =[153/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 439 and i <=456 ):
           colors[i] =[153/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 591 and i <=608 ):
           colors[i] =[153/255, 0/255, 0/255]
...
data=read('Pt7O8_CO_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7O8CO_Al2O3_0001_Echem_DFTopt_{}'.format(j)
