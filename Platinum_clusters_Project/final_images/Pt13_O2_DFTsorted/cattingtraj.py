...
traj = Trajectory('Pt13_O2_Al2O3_KRRfund9l_DFTrelaxed.traj','w')
for i in range(1,7):
    data =[]
    stru = '../Pt13_O2_{}/Pt13_O2_Al2O3_KRRfund9l_DFTrelaxed.traj'.format(i)
    data = read(stru+'@:')
...
data1=read('Pt13_O2_Al2O3_KRRfund9l_DFTrelaxed.traj@:')
data1.sort(key=lambda x: x.get_potential_energy())
traj = Trajectory('Pt13_O2_Al2O3_KRRfund9l_DFTrelaxedsorted.traj','w')
