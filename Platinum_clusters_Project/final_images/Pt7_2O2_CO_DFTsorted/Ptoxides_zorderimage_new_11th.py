...
for j in range(11,len(data)):
   ...
   # write('newimage.traj',atoms)
    ...
    atoms = data[j]*(3,3,1)
    a=atoms
    del atoms[atoms.positions[:,0] >=centreofmass[0]+10.5]
    ...
    ax.set_xlim([centreofmass[0]-6.5, centreofmass[0]+9.50])
    ...
    ax.set_xlim([centreofmass[0]-6.5, centreofmass[0]+9.50])
    ax.set_ylim([centreofmass[1]-6.5, centreofmass[1]+7.5])
