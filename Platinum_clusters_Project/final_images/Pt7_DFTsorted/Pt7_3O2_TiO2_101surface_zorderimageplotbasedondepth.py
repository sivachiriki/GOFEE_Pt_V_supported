...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
       ...
       # if (atom.number ==8 and i >= 142 and i <=145 ):
       #    colors[i] =[0.1, 0.2, 0.5]
       # if (atom.number ==8 and i >= 285 and i <=289 ):
       #    colors[i] =[0.1, 0.2, 0.2]
       # if (atom.number ==8 and i >= 430 and i <=433 ):
       #    colors[i] =[0.1, 0.2, 0.2]
       # if (atom.number ==8 and i >= 574 and i <=576 ):
       #    colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt7_Al2O3_KRRfund9l_DFTrelaxedsorted1.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7_Al2O3_0001_DFTopt_n{}'.format(j)
