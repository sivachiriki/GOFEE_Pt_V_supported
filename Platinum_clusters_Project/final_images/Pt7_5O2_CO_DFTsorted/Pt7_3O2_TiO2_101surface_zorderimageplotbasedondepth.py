...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=154 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 289 and i <=308 ):
           colors[i] =[0.1, 0.2, 0.4]
        if (atom.number ==8 and i >= 443 and i <=462 ):
           colors[i] =[0.1, 0.2, 0.4]
        if (atom.number ==8 and i >= 597 and i <=616 ):
           colors[i] =[0.1, 0.2, 0.4]
...
data=read('Pt7O10_CO_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7O10_CO_Al2O3_0001_DFTopt_g{}'.format(j)
