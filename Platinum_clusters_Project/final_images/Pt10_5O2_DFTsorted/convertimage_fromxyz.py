...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=155 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 300 and i <=310 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 455 and i <=465 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 610 and i <=620):
           colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt10_5O2_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt10_5O2_Al2O3_0001_DFTopt_g{}'.format(j)
