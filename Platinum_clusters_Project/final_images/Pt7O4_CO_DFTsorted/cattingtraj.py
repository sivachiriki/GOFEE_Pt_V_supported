...
traj = Trajectory('Pt7O4_CO_Al2O3_KRRfund9l_DFTrelaxed.traj','w')
for i in range(1,10):
    data =[]
...
data1=read('Pt7O4_CO_Al2O3_KRRfund9l_DFTrelaxed.traj@:')
data1.sort(key=lambda x: x.get_potential_energy())
traj = Trajectory('Pt7O4_CO_Al2O3_KRRfund9l_DFTrelaxedsorted.traj','w')
