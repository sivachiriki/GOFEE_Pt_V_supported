...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 136 and i <=146 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 289 and i <=292 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 435 and i <=438 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 581 and i <=584 ):
           colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt7_2O2_Al2O3_KRRfund9l_DFTrelaxedsorted1.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7_2O2_Al2O3_0001_DFTopt_n{}'.format(j)
