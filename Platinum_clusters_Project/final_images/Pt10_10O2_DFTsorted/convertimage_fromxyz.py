...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=163 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 310 and i <=330 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 475 and i <=495 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 640 and i <=660):
           colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt10_10O2_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt10_10O2_Al2O3_0001_DFTopt_g{}'.format(j)
