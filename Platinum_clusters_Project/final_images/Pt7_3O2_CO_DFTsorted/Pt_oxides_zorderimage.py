...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=150 ):
           colors[i] =[153/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 285 and i <=300 ):
           colors[i] =[153/255, 0/255, 0/255]
       # if (atom.number ==8 and i >= 453 and i <=468 ):
       #    colors[i] =[0.1, 0.2, 0.2]
       # if (atom.number ==8 and i >= 609 and i <=624 ):
       #    colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt7O6_CO_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7O6CO_Al2O3_0001_Echem_DFTopt_{}'.format(j)
