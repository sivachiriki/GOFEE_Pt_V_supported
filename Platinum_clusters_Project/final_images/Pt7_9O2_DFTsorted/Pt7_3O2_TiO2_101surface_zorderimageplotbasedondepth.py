...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=160 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 301 and i <=320 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 461 and i <=476 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 617 and i <=632 ):
           colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt7_9O2_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7_9O2_Al2O3_0001_DFTopt_g{}'.format(j)
