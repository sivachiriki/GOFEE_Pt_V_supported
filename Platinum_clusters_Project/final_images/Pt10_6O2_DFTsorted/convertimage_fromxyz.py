...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=157 ):
           colors[i] =[0.1, 0.2, 0.5]
        if (atom.number ==8 and i >= 302 and i <=314 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 459 and i <=471 ):
           colors[i] =[0.1, 0.2, 0.2]
        if (atom.number ==8 and i >= 616 and i <=628):
           colors[i] =[0.1, 0.2, 0.2]
...
data=read('Pt10_6O2_Al2O3_KRRfund9l_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt10_6O2_Al2O3_0001_DFTopt_g{}'.format(j)
