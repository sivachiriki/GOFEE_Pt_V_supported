...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=158 ):
           colors[i] =[102/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 293 and i <=316 ):
           colors[i] =[102/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 453 and i <=474 ):
           colors[i] =[102/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 609 and i <=632 ):
           colors[i] =[102/255, 0/255, 0/255]
...
for j in range(0,len(data)):
    ...
    for i,a in enumerate(image):
        ...
        if a.position[0] >7.100 and i<=158:
