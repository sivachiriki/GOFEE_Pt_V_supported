...
for j in range(0,9):
   ...
   # write('newimage.traj',atoms)
    ...
    fig.add_subplot(ax)
    if (j ==0):
       name2 ='Pt$_7$O$_{16}$ Lowest Isomers'
       ax.set_title(name2)
    ...
    ax.set_xlim([centreofmass[0]-8.0, centreofmass[0]+8.0])
    ax.set_ylim([centreofmass[1]-7.0, centreofmass[1]+7.50])
...
for j in range(0,len(data)):
   ...
   # write('newimage.traj',atoms)
    a=atoms
    del atoms[[atom.index for atom in atoms if atom.index <=colorlenth*5-26 or atom.index >=colorlenth*5]]
    #view(atoms)
    centreofmass = a.get_center_of_mass()
    atoms = data[j]*(3,3,1)
    a=atoms
    ...
    fig.add_subplot(ax)
    if (j ==0):
       name2 ='Pt$_7$O$_{16}$CO Lowest Isomers'
       ax.set_title(name2) 
    #----------------- drawing box -------------------------------#
