...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 135 and i <=159 ):
           colors[i] =[153/255, 0/255, 0/255]
        if (atom.number ==8 and i >= 294 and i <=318 ):
           colors[i] =[153/255, 0/255, 0/255]
...
data=read('Pt7O16CO_GM_Al2O3_0001surface_DFTrelaxedsorted.traj@:')
...
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='Pt7O16CO_Al2O3_0001_Echem_DFTopt_GM'
