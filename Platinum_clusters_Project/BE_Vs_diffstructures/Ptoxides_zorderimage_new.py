...
gridspec.GridSpec([-3.0,1.0], 8, wspace=0.04, hspace=0.2)
...
for j in range(0,len(data)):
    ...
    inner = gridspec.GridSpecFromSubplotSpec(2, 1,subplot_spec=gridspec.GridSpec(energydif[j],j, wspace=0.04, hspace=0.2), wspace=0.00, hspace=0.0, height_ratios=[6.86,9.9])
    atoms = data[j]
