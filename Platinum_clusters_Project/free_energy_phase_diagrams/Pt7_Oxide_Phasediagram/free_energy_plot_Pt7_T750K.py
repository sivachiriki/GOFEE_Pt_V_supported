...
O2 = read('O2_molecule_DFTrelaxed_kpts331.traj')
Pt7 = read('Pt7_Al2O3_Planar_DFTrelaxed_kpts331.traj')
#Pt7 = read('Pt7_Al2O3_prismatic_DFTrelaxed_kpts331.traj')
Pt7_O2 = read('Pt7_O2_Al2O3_GM_DFTrelaxed_kpts331.traj')
Pt7_2O2 = read('Pt7_2O2_Al2O3_GM_DFTrelaxed_kpts331.traj')
Pt7_3O2 = read('Pt7_3O2_Al2O3_GM_DFTrelaxed_kpts331.traj')
#Pt7_4O2 = read('Pt7_4O2_PlanarGM_DFTrelaxed_kpts331.traj')
#Pt7_4O2 = read('Pt7_4O2_Al2O3_Hexagon_DFTrelaxed_kpts331.traj')
Pt7_4O2 = read('Pt7_4O2_Al2O3_nanoribbon_DFTrelaxed_kpts331.traj')
Pt7_5O2 = read('Pt7_5O2_Al2O3_HexagonGM_DFTrelaxed_kpts331.traj')
Pt7_6O2 = read('Pt7_6O2_Al2O3_GM_DFTrelaxed_kpts331.traj')
#Pt7_7O2 = read('Pt7_7O2_Al2O3_GM_DFTrelaxed_kpts331.traj')
#Pt7_7O2 = read('Pt7_7O2_Al2O3_nonclosedHexagon_DFTrelaxed_kpts331.traj')
Pt7_7O2 = read('Pt7_7O2_Al2O3_HexagonGM_DFTrelaxed_kpts331.traj')
...
color_lib = ['#377eb8','#4daf4a','#984ea3','#a65628','#999999','#fdbf6f', '#ff7f00']
resolution = 300
alpha_back =0.70
alpha_front =1.0
...
for i,T in enumerate(T_range):
    ...
    #print('z value at every i',z[i][:])
    #print('levels at every i',levels)
...
ax2.text(0.1, 0.9,'Pt$_7$O$_{14}$',color=color_levels1[6],alpha=1.0,fontsize=16, transform=ax2.transAxes)
ax2.text(0.2, 0.5,'Pt$_7$O$_{12}$',fontsize=16,color=color_levels1[5],alpha=1.0,transform=ax2.transAxes)
ax2.text(0.45, 0.45,'Pt$_7$O$_{10}$',fontsize=16, color=color_levels1[4],alpha=1.0,transform=ax2.transAxes)
...
ax2.text(0.7, 0.37,'Pt$_7$O$_{4}$',fontsize=16,color=color_levels1[1],alpha=1.0,transform=ax2.transAxes)
ax2.text(0.7, 0.2,'Pt$_7$O$_{2}$',fontsize=16,color=color_levels1[0],alpha=1.0,transform=ax2.transAxes)

savefig('free_energy_diagram_Pt7Oxides_750K.png')
plt.show()
