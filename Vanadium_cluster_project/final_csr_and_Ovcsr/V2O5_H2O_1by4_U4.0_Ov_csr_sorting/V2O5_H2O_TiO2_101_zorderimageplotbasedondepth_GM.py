...
def plot_conf(ax, atoms, rot=False):
    ...
    for i, atom in enumerate(atoms):
        ...
        if (atom.number ==8 and i >= 144 and i <= 152):
...
data=read('V2O5_H2O_TiO2_101_1by4cell_Ov_U4.0DFTrelaxedsorted.traj@:')
for j in range(len(data)):
    ...
    plt.tight_layout()
    name ='V2O5_H2O_TiO2_101_1by4cell_DFTcsr_Ov_g{}'.format(j)
