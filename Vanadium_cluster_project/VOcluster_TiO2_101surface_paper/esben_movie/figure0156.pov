...
atom(< -3.63,  -4.33,  -9.10>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #12 
...
atom(<-12.94,  -4.34,  -7.55>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #16 
atom(< -7.75,  -6.26,  -7.57>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #17 
atom(<-12.52,  -6.25,  -7.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #18 
atom(< -7.34,  -4.34,  -7.64>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #19 
atom(< -4.38,  -4.34,  -6.70>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #20 
atom(< -9.53,  -6.24,  -6.72>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #21 
atom(< -5.85,  -6.25,  -8.23>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #22 
atom(<-11.04,  -4.34,  -8.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #23 
atom(<-12.44,  -4.32,  -5.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #24 
atom(< -7.25,  -6.25,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #25 
atom(< -9.14,  -6.25,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #26 
atom(< -3.97,  -4.34,  -4.66>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #27 
atom(<-11.48,  -4.33,  -4.11>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #28 
atom(< -6.32,  -6.26,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #29 
atom(<-10.97,  -6.22,  -3.91>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #30 
atom(< -5.81,  -4.34,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #31 
atom(<-13.09,  -4.35,  -3.21>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #32 
atom(< -7.95,  -6.29,  -3.23>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #33 
...
atom(< -5.44,  -0.52,  -8.29>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #51 
atom(<-12.93,  -0.51,  -7.46>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #52 
atom(< -7.76,  -2.41,  -7.57>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #53 
...
atom(< -9.53,  -2.44,  -6.72>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #57 
atom(< -5.85,  -2.42,  -8.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #58 
atom(<-11.02,  -0.51,  -8.20>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #59 
atom(<-12.45,  -0.52,  -5.54>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #60 
atom(< -7.25,  -2.42,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #61 
atom(< -9.13,  -2.42,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #62 
atom(< -3.91,  -0.51,  -4.61>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #63 
atom(<-11.45,  -0.52,  -3.91>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #64 
atom(< -6.32,  -2.42,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #65 
atom(<-10.96,  -2.45,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #66 
atom(< -5.81,  -0.52,  -3.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #67 
atom(<-13.13,  -0.51,  -3.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #68 
atom(< -7.94,  -2.41,  -3.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #69 
atom(< -4.33,  -2.43,  -4.60>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #70 
atom(< -9.52,  -0.52,  -4.68>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #71 
atom(<-12.33,   1.66,  -0.63>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #72 
atom(<-13.05,   1.11,  -0.16>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #73 
atom(<-12.09,   2.42,   0.00>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #74 
atom(<-12.78,   2.08,  -1.45>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #75 
atom(<-10.52,  -0.40,  -1.87>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #76 
atom(<-11.03,   0.33,  -1.33>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #77 
atom(<-10.56,  -1.29,  -1.36>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #78 
atom(< -9.53,  -0.14,  -1.95>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #79 
...
atom(<-12.94,   3.31,  -7.55>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #96 
atom(< -7.75,   1.38,  -7.57>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #97 
...
atom(<-12.44,   3.33,  -5.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #104 
atom(< -7.25,   1.40,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #105 
atom(< -9.14,   1.40,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #106 
atom(< -3.97,   3.31,  -4.66>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #107 
atom(<-11.48,   3.31,  -4.11>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #108 
atom(< -6.32,   1.38,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #109 
atom(<-10.97,   1.42,  -3.91>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #110 
atom(< -5.81,   3.30,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #111 
atom(<-13.09,   3.30,  -3.21>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #112 
atom(< -7.95,   1.36,  -3.23>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #113 
atom(< -4.33,   1.39,  -4.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #114 
...
atom(< -7.76,   5.23,  -7.57>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #133 
...
atom(<-11.02,   7.13,  -8.20>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #139 
atom(<-12.45,   7.12,  -5.54>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #140 
atom(< -7.25,   5.22,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #141 
atom(< -9.13,   5.22,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #142 
atom(< -3.91,   7.13,  -4.61>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #143 
atom(<-11.45,   7.13,  -3.91>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #144 
atom(< -6.32,   5.23,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #145 
atom(<-10.96,   5.20,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #146 
atom(< -5.81,   7.13,  -3.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #147 
atom(<-13.13,   7.14,  -3.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #148 
atom(< -7.94,   5.24,  -3.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #149 
atom(< -4.33,   5.22,  -4.60>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #150 
atom(< -9.52,   7.13,  -4.68>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #151 
atom(<-12.33,   9.30,  -0.63>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #152 
atom(<-13.05,   8.75,  -0.16>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #153 
atom(<-12.09,  10.07,   0.00>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #154 
atom(<-12.78,   9.73,  -1.45>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #155 
atom(<-10.52,   7.24,  -1.87>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #156 
atom(<-11.03,   7.97,  -1.33>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #157 
atom(<-10.56,   6.36,  -1.36>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #158 
atom(< -9.53,   7.51,  -1.95>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #159 
...
atom(<  6.71,  -4.33,  -9.10>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #172 
atom(<  1.54,  -6.25,  -9.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #173 
...
atom(<  3.00,  -4.34,  -7.64>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #179 
atom(<  5.97,  -4.34,  -6.70>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #180 
atom(<  0.81,  -6.24,  -6.72>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #181 
atom(<  4.50,  -6.25,  -8.23>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #182 
atom(< -0.69,  -4.34,  -8.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #183 
atom(< -2.10,  -4.32,  -5.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #184 
atom(<  3.09,  -6.25,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #185 
atom(<  1.20,  -6.25,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #186 
atom(<  6.38,  -4.34,  -4.66>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #187 
atom(< -1.14,  -4.33,  -4.11>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #188 
atom(<  4.02,  -6.26,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #189 
atom(< -0.63,  -6.22,  -3.91>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #190 
atom(<  4.54,  -4.34,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #191 
atom(< -2.75,  -4.35,  -3.21>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #192 
atom(<  2.39,  -6.29,  -3.23>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #193 
atom(<  6.01,  -6.25,  -4.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #194 
...
atom(<  1.54,  -2.42,  -9.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #209 
atom(< -0.33,  -2.42,  -8.31>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #210 
atom(<  4.90,  -0.52,  -8.29>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #211 
...
atom(<  0.81,  -2.44,  -6.72>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #217 
atom(<  4.50,  -2.42,  -8.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #218 
atom(< -0.68,  -0.51,  -8.20>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #219 
atom(< -2.11,  -0.52,  -5.54>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #220 
atom(<  3.09,  -2.42,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #221 
atom(<  1.21,  -2.42,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #222 
atom(<  6.43,  -0.51,  -4.61>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #223 
atom(< -1.10,  -0.52,  -3.91>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #224 
atom(<  4.02,  -2.42,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #225 
atom(< -0.62,  -2.45,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #226 
atom(<  4.53,  -0.52,  -3.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #227 
atom(< -2.79,  -0.51,  -3.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #228 
atom(<  2.40,  -2.41,  -3.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #229 
atom(<  6.02,  -2.43,  -4.60>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #230 
atom(<  0.82,  -0.52,  -4.68>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #231 
atom(< -1.99,   1.66,  -0.63>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #232 
atom(< -2.71,   1.11,  -0.16>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #233 
atom(< -1.75,   2.42,   0.00>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #234 
atom(< -2.43,   2.08,  -1.45>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #235 
atom(< -0.17,  -0.40,  -1.87>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #236 
atom(< -0.68,   0.33,  -1.33>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #237 
atom(< -0.22,  -1.29,  -1.36>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #238 
atom(<  0.81,  -0.14,  -1.95>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #239 
...
atom(<  1.54,   1.40,  -9.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #253 
...
atom(<  2.59,   1.38,  -7.57>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #257 
atom(< -2.18,   1.40,  -7.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #258 
atom(<  3.00,   3.31,  -7.64>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #259 
atom(<  5.97,   3.31,  -6.70>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #260 
...
atom(< -2.10,   3.33,  -5.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #264 
atom(<  3.09,   1.40,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #265 
atom(<  1.20,   1.40,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #266 
atom(<  6.38,   3.31,  -4.66>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #267 
atom(< -1.14,   3.31,  -4.11>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #268 
atom(<  4.02,   1.38,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #269 
atom(< -0.63,   1.42,  -3.91>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #270 
atom(<  4.54,   3.30,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #271 
atom(< -2.75,   3.30,  -3.21>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #272 
atom(<  2.39,   1.36,  -3.23>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #273 
atom(<  6.01,   1.39,  -4.61>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #274 
...
atom(<  1.54,   5.22,  -9.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #289 
...
atom(< -2.11,   7.12,  -5.54>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #300 
atom(<  3.09,   5.22,  -5.62>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #301 
atom(<  1.21,   5.22,  -4.69>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #302 
atom(<  6.43,   7.13,  -4.61>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #303 
atom(< -1.10,   7.13,  -3.91>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #304 
atom(<  4.02,   5.23,  -4.09>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #305 
atom(< -0.62,   5.20,  -3.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #306 
atom(<  4.53,   7.13,  -3.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #307 
atom(< -2.79,   7.14,  -3.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #308 
atom(<  2.40,   5.24,  -3.22>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #309 
atom(<  6.02,   5.22,  -4.60>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #310 
