...
atom(< -5.50,  -4.34,  -8.57>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #15 
atom(<-12.95,  -4.33,  -7.80>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #16 
atom(< -7.75,  -6.26,  -7.83>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #17 
atom(<-12.52,  -6.25,  -7.87>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #18 
atom(< -7.34,  -4.33,  -7.90>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #19 
atom(< -4.38,  -4.34,  -6.96>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #20 
atom(< -9.53,  -6.24,  -6.98>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #21 
atom(< -5.85,  -6.25,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #22 
atom(<-11.04,  -4.34,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #23 
atom(<-12.45,  -4.32,  -5.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #24 
atom(< -7.25,  -6.25,  -5.88>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #25 
atom(< -9.14,  -6.25,  -4.95>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #26 
atom(< -3.96,  -4.34,  -4.90>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #27 
atom(<-11.48,  -4.34,  -4.36>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #28 
atom(< -6.32,  -6.26,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #29 
atom(<-10.96,  -6.22,  -4.15>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #30 
atom(< -5.81,  -4.34,  -4.12>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #31 
atom(<-13.09,  -4.36,  -3.46>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #32 
atom(< -7.95,  -6.28,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #33 
atom(< -4.33,  -6.25,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #34 
atom(< -9.49,  -4.34,  -4.92>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #35 
...
atom(< -3.62,  -0.51,  -9.33>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #48 
...
atom(< -9.53,  -2.44,  -6.98>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #57 
atom(< -5.85,  -2.42,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #58 
atom(<-11.03,  -0.51,  -8.45>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #59 
atom(<-12.45,  -0.52,  -5.79>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #60 
atom(< -7.25,  -2.42,  -5.88>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #61 
atom(< -9.13,  -2.42,  -4.95>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #62 
atom(< -3.91,  -0.51,  -4.87>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #63 
atom(<-11.44,  -0.52,  -4.16>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #64 
atom(< -6.32,  -2.42,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #65 
atom(<-10.96,  -2.45,  -4.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #66 
atom(< -5.81,  -0.52,  -4.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #67 
atom(<-13.12,  -0.51,  -3.39>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #68 
atom(< -7.95,  -2.41,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #69 
atom(< -4.32,  -2.43,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #70 
atom(< -9.53,  -0.52,  -4.95>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #71 
atom(<-12.65,   0.71,  -0.59>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #72 
atom(<-13.20,  -0.00,  -0.12>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #73 
atom(<-12.69,   1.54,   0.00>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #74 
atom(<-13.12,   0.93,  -1.46>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #75 
atom(<-10.43,  -0.46,  -2.15>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #76 
atom(<-11.07,  -0.05,  -1.45>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #77 
atom(<-10.15,  -1.38,  -1.84>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #78 
atom(< -9.58,   0.10,  -2.19>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #79 
...
atom(< -7.75,   1.39,  -7.83>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #97 
...
atom(<-12.45,   3.32,  -5.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #104 
atom(< -7.25,   1.40,  -5.88>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #105 
atom(< -9.14,   1.40,  -4.95>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #106 
atom(< -3.96,   3.31,  -4.90>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #107 
atom(<-11.48,   3.31,  -4.36>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #108 
atom(< -6.32,   1.38,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #109 
atom(<-10.96,   1.42,  -4.15>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #110 
atom(< -5.81,   3.30,  -4.12>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #111 
atom(<-13.09,   3.29,  -3.46>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #112 
atom(< -7.95,   1.36,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #113 
atom(< -4.33,   1.39,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #114 
...
atom(< -3.62,   7.13,  -9.33>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #128 
...
atom(<-12.45,   7.12,  -5.79>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #140 
atom(< -7.25,   5.22,  -5.88>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #141 
atom(< -9.13,   5.22,  -4.95>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #142 
atom(< -3.91,   7.13,  -4.87>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #143 
atom(<-11.44,   7.13,  -4.16>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #144 
atom(< -6.32,   5.23,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #145 
atom(<-10.96,   5.19,  -4.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #146 
atom(< -5.81,   7.13,  -4.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #147 
atom(<-13.12,   7.14,  -3.39>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #148 
atom(< -7.95,   5.24,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #149 
atom(< -4.32,   5.22,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #150 
atom(< -9.53,   7.13,  -4.95>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #151 
atom(<-12.65,   8.36,  -0.59>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #152 
atom(<-13.20,   7.64,  -0.12>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #153 
atom(<-12.69,   9.19,   0.00>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #154 
atom(<-13.12,   8.57,  -1.46>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #155 
atom(<-10.43,   7.19,  -2.15>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #156 
atom(<-11.07,   7.60,  -1.45>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #157 
atom(<-10.15,   6.26,  -1.84>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #158 
atom(< -9.58,   7.75,  -2.19>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #159 
...
atom(<  4.84,  -4.34,  -8.57>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #175 
atom(< -2.61,  -4.33,  -7.80>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #176 
...
atom(<  5.96,  -4.34,  -6.96>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #180 
atom(<  0.81,  -6.24,  -6.98>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #181 
atom(<  4.50,  -6.25,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #182 
atom(< -0.70,  -4.34,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #183 
atom(< -2.10,  -4.32,  -5.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #184 
atom(<  3.09,  -6.25,  -5.88>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #185 
atom(<  1.21,  -6.25,  -4.95>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #186 
atom(<  6.38,  -4.34,  -4.90>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #187 
atom(< -1.14,  -4.34,  -4.36>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #188 
atom(<  4.02,  -6.26,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #189 
atom(< -0.62,  -6.22,  -4.15>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #190 
atom(<  4.53,  -4.34,  -4.12>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #191 
atom(< -2.75,  -4.36,  -3.46>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #192 
atom(<  2.39,  -6.28,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #193 
atom(<  6.01,  -6.25,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #194 
atom(<  0.85,  -4.34,  -4.92>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #195 
...
atom(<  0.81,  -2.44,  -6.98>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #217 
atom(<  4.50,  -2.42,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #218 
atom(< -0.68,  -0.51,  -8.45>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #219 
atom(< -2.10,  -0.52,  -5.79>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #220 
atom(<  3.09,  -2.42,  -5.88>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #221 
atom(<  1.21,  -2.42,  -4.95>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #222 
atom(<  6.44,  -0.51,  -4.87>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #223 
atom(< -1.10,  -0.52,  -4.16>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #224 
atom(<  4.02,  -2.42,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #225 
atom(< -0.62,  -2.45,  -4.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #226 
atom(<  4.54,  -0.52,  -4.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #227 
atom(< -2.78,  -0.51,  -3.39>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #228 
atom(<  2.40,  -2.41,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #229 
atom(<  6.02,  -2.43,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #230 
atom(<  0.82,  -0.52,  -4.95>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #231 
atom(< -2.31,   0.71,  -0.59>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #232 
atom(< -2.86,  -0.00,  -0.12>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #233 
atom(< -2.35,   1.54,   0.00>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #234 
atom(< -2.78,   0.93,  -1.46>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #235 
atom(< -0.09,  -0.46,  -2.15>, 0.80, rgb <0.19, 0.31, 0.97>, 0.0, pale) // #236 
atom(< -0.73,  -0.05,  -1.45>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #237 
atom(<  0.19,  -1.38,  -1.84>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #238 
atom(<  0.76,   0.10,  -2.19>, 0.30, rgb <1.00, 1.00, 1.00>, 0.0, pale) // #239 
...
atom(<  2.59,   1.39,  -7.83>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #257 
...
atom(< -0.70,   3.31,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #263 
atom(< -2.10,   3.32,  -5.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #264 
...
atom(<  4.02,   1.38,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #269 
atom(< -0.62,   1.42,  -4.15>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #270 
atom(<  4.53,   3.30,  -4.12>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #271 
atom(< -2.75,   3.29,  -3.46>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #272 
atom(<  2.39,   1.36,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #273 
atom(<  6.01,   1.39,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #274 
...
atom(<  4.50,   5.22,  -8.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #298 
atom(< -0.68,   7.13,  -8.45>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #299 
atom(< -2.10,   7.12,  -5.79>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #300 
atom(<  3.09,   5.22,  -5.88>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #301 
atom(<  1.21,   5.22,  -4.95>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #302 
atom(<  6.44,   7.13,  -4.87>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #303 
atom(< -1.10,   7.13,  -4.16>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #304 
atom(<  4.02,   5.23,  -4.35>, 1.30, rgb <0.75, 0.76, 0.78>, 0.0, pale) // #305 
atom(< -0.62,   5.19,  -4.13>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #306 
atom(<  4.54,   7.13,  -4.11>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #307 
atom(< -2.78,   7.14,  -3.39>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #308 
atom(<  2.40,   5.24,  -3.48>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #309 
atom(<  6.02,   5.22,  -4.86>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #310 
atom(<  0.82,   7.13,  -4.95>, 0.74, rgb <0.84, 0.32, 0.33>, 0.0, pale) // #311 
