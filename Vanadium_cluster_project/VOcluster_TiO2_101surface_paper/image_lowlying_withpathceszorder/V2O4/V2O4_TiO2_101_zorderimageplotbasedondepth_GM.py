...
def plot_conf(ax, atoms, rot=False):
    ...
    colors[339] = [0.1, 0.2, 0.5]
    colors[341] = [0.1, 0.2, 0.5]
...
data=read('V2O4_TiO2_101_DFTlowlyingsorted.traj@:')
...
plt.tight_layout()
savefig('V2O4_TiO2_101_DFTopt_30th.pdf',bbox_inches='tight')
show()
