...
data=read('VO2TiO2_101surface_KRRfund_DFTrelaxedsorted.traj@:')

image = data[0]
for i,a in enumerate(image):
    if a.position[1] >7.00:
...
plt.tight_layout()
savefig('VO2_TiO2_101_DFTopt_GM.pdf',bbox_inches='tight')
show()
