...
def plot_conf(ax, atoms, rot=False):
    ...
    colors[345] = [0.1, 0.1, 0.2]
    colors[346] = [0.1, 0.1, 0.2]
    colors[109] = [0.1, 0.1, 0.5]
    colors[110] = [0.1, 0.1, 0.5]
    colors[111] = [0.1, 0.1, 0.5]
    colors[112] = [0.1, 0.1, 0.5]
    colors[113] = [0.1, 0.1, 0.5]
    colors[114] = [0.1, 0.1, 0.5]
    colors[115] = [0.9, 0.3, 0.9]
    colors[116] = [0.9, 0.3, 0.9]
    colors[117] = [0.9, 0.3, 0.9]
    colors[118] = [0.9, 0.3, 0.9]

    colors[347] = [0.1, 0.1, 0.5]
    colors[349] = [0.1, 0.1, 0.5]
    colors[350] = [0.1, 0.1, 0.5]
    colors[351] = [0.1, 0.1, 0.5]
    colors[352] = [0.1, 0.1, 0.5]
    
    colors[353] = [0.9, 0.3, 0.9]
    colors[354] = [0.9, 0.3, 0.9]
    colors[355] = [0.9, 0.3, 0.9]
...
data=read('V2O4_2H2O_TiO2_101_Ovacancy_DFTlowlyingsorted.traj@:')
...
plt.tight_layout()
savefig('V2O4_2H2O_TiO2_101_DFTopt_Ov_stru5.pdf',bbox_inches='tight')
show()
