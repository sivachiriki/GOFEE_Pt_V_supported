...
def plot_conf(ax, atoms, rot=False):
    ...
    colors[144] = [0.1, 0.1, 0.2]
    colors[145] = [0.1, 0.1, 0.2]
    #colors[223] = [0.1, 0.1, 0.2]
    #colors[338] = [0.1, 0.2, 0.5]
    colors[146] = [0.1, 0.2, 0.5]
    colors[147] = [0.1, 0.2, 0.5]
    colors[148] = [0.1, 0.2, 0.5]
    colors[149] = [0.1, 0.2, 0.5]
    colors[150] = [0.1, 0.2, 0.5]
...
data=read('V2O5_TiO2_101_1by4cell_DFTlowlyingsorted.traj@:')
...
plt.tight_layout()
savefig('V2O5_TiO2_101_1by4cell_DFTcomplerelax_g27.pdf',bbox_inches='tight')
show()
