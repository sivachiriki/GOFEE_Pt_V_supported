...
data=read('VO2_Ovacancy_H2O_TiO2_101_DFTlowlyingsorted1.traj@:')
image = data[11] * (2,2,1)
...
plt.tight_layout()
savefig('VO2_Ov_H2O_TiO2_101_DFTopt_12th.pdf',bbox_inches='tight')
show()
