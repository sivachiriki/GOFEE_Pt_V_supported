...
traj = Trajectory('V2O5_H2O_TiO2_101_DFTefxed_rhighlevel.traj','w')
for i in range(1,3):
    data =[]
    stru = '{}.traj'.format(i)
    data = read(stru+'@:')
...
data1=read('V2O5_H2O_TiO2_101_DFTefxed_rhighlevel.traj@:')
data1.sort(key=lambda x: x.get_potential_energy())
traj = Trajectory('V2O5_H2O_TiO2_101_DFTefxed_rhighlevelsorted.traj','w')
