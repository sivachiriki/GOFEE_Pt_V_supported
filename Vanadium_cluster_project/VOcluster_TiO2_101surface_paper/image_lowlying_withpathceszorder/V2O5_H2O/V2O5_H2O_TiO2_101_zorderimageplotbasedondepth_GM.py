...
def plot_conf(ax, atoms, rot=False):
    ...
    colors[223] = [0.1, 0.1, 0.2]
    colors[338] = [0.1, 0.2, 0.5]
...
data=read('V2O5_H2OTiO2_101surface_DFTrelaxed_startgm.traj@:')

image = data[6]
for i,a in enumerate(image):
    if a.position[1] >11.10:
       image.positions[i,1] =0.0000
   # if i ==112:
   #    image.positions[i,0] =10.342
...
plt.tight_layout()
savefig('V2O5_H2O_TiO2_101_DFTopt_startgm7.pdf',bbox_inches='tight')
show()
