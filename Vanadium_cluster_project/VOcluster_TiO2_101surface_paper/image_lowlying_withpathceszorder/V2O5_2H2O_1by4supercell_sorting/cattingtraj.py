...
traj = Trajectory('V2O5_2H2O_TiO2_101_1by4cell_DFTlowlying.traj','w')
for i in range(1,14):
    data =[]
    stru = '{}.traj'.format(i)
    data = read(stru+'@:')
...
data1=read('V2O5_2H2O_TiO2_101_1by4cell_DFTlowlying.traj@:')
data1.sort(key=lambda x: x.get_potential_energy())
traj = Trajectory('V2O5_2H2O_TiO2_101_1by4cell_DFTlowlyingsorted.traj','w')
