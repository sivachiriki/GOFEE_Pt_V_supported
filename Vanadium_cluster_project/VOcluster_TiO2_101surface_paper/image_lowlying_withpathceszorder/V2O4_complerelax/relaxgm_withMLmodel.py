...
traj = Trajectory('V2O4_101_fullyrelax_DFTrelaxed.traj','w')
name ='V2O4_101surface_gm'
data = read('V2O4_TiO2_101_DFTefxed_rhighlevelsorted.traj@:')
for i in range(2,len(data)):
    name ='V2O4_101surface_isomer_{}'.format(i)
    a=data[i]
