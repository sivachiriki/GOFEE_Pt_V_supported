...
traj = Trajectory('V2O5_TiO2_101_1by4cell_Ov_U4.0DFTrelaxed.traj','w')
for i in range(0,3):
    data =[]
    stru = '../V2O5_1by4_U4.0_Ov_csr_{}/V2O5_TiO2_101_1by4cell_DFTrelaxed.traj'.format(i)
    data = read(stru+'@:')
    for j in range(0,len(data)):
        traj.write(data[j])

data1=read('V2O5_TiO2_101_1by4cell_Ov_U4.0DFTrelaxed.traj@:')
data1.sort(key=lambda x: x.get_potential_energy())
traj = Trajectory('V2O5_TiO2_101_1by4cell_Ov_U4.0DFTrelaxedsorted.traj','w')
