...
def plot_conf(ax, atoms, rot=False):
    ...
    colors[342] = [0.1, 0.1, 0.2]
    colors[344] = [0.1, 0.2, 0.5]
    colors[345] = [0.1, 0.2, 0.5]
    colors[346] = [0.1, 0.2, 0.5]
    colors[347] = [0.1, 0.2, 0.5]
    colors[348] = [0.1, 0.2, 0.5]
    ...
    colors[349] = [0.9, 0.3, 0.9]
    colors[350] = [0.9, 0.3, 0.9]
    #print(colors)
    #exit()
...
data=read('V2O4_H2O_TiO2_101surface_DFTrelaxed_rhighlevel1.traj@:')
...
print(cell[0,0])
print(cell[1,1])
#ax.set_xlim([0.00, cell[0,0]/1.8])
ax.set_xlim([7.10,17.42])
...
plt.tight_layout()
savefig('V2O4_H2O_TiO2_101_DFTopt_newstu1.pdf',bbox_inches='tight')
show()
