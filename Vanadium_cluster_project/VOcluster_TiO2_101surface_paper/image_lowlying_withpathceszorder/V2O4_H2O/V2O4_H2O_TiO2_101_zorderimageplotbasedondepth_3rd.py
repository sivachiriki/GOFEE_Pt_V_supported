...
data=read('V2O4_H2O_TiO2_101surface_KRRfund_DFTrelaxed_startgm.traj@:')
...
for i,a in enumerate(image):
    ...
    if i ==113:
       image.positions[i,0] =image.positions[i,0]+10.342
...
plt.figure(figsize=(6.5,9.50))

gs = gridspec.GridSpec(2, 1,
                       height_ratios=[6.32,9.20])
...
plt.tight_layout()
savefig('V2O4_H2O_TiO2_101_DFTopt_startgm4.pdf',bbox_inches='tight')
show()
