...
def plot_conf(ax, atoms, rot=False):
    ...
    colors[109] = [0.1, 0.1, 0.2]
    colors[348] = [0.1, 0.1, 0.2]
    colors[349] = [0.1, 0.1, 0.2]
    colors[350] = [0.1, 0.2, 0.5]
    colors[352] = [0.1, 0.2, 0.5]
    colors[353] = [0.1, 0.2, 0.5]
    colors[354] = [0.1, 0.2, 0.5]
    colors[355] = [0.1, 0.2, 0.5]
    colors[110] = [0.1, 0.2, 0.5]
    colors[111] = [0.1, 0.2, 0.5]
    colors[112] = [0.1, 0.2, 0.5]
    colors[113] = [0.1, 0.2, 0.5]
    colors[114] = [0.1, 0.2, 0.5]
    colors[115] = [0.1, 0.2, 0.5]
    colors[238] = [0.1, 0.2, 0.5]
    colors[226] = [0.1, 0.2, 0.5]
    colors[227] = [0.1, 0.2, 0.5]
    colors[116] = [0.9, 0.3, 0.9]
    colors[117] = [0.9, 0.3, 0.9]
    colors[118] = [0.9, 0.3, 0.9]
    colors[119] = [0.9, 0.3, 0.9]
    colors[356] = [0.9, 0.3, 0.9]
    colors[357] = [0.9, 0.3, 0.9]
    colors[359] = [0.9, 0.3, 0.9]
    colors[358] = [0.9, 0.3, 0.9]
    #print(colors)
    #exit()
...
data=read('V2O4_2H2O_TiO2_101_DFTlowlyingsorted.traj@:')

image = data[8]
for i,a in enumerate(image):
    if a.position[1] >11.000:
       image.positions[i,1] =0.000
    #if i ==111:
    #   image.positions[i,1] =0.00
...
plt.figure(figsize=(6.5,10.0))

gs = gridspec.GridSpec(2, 1,
                       height_ratios=[6.32,9.5])
...
print(cell[0,0])
print(cell[1,1])
ax.set_xlim([0.0, cell[0,0]/1.8])
#ax.set_xlim([7.1,17.1])
...
plt.tight_layout()
savefig('V2O4_2H2O_TiO2_101_DFTopt_9th.pdf',bbox_inches='tight')
show()
