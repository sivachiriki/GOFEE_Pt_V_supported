...
traj = Trajectory('V2O5_H2O_Ovcy_TiO2_101surface_DFTrelaxed.traj','w')
name ='V2O5_H2O_Ovcy_TiO2_101surface_gm'
data = read('V2O5_H2O_Ovcy_TiO2_101_newstrufound.traj@:')
for i in range(0,len(data)):
    name ='V2O5_H2O_Ovcy_TiO2_101surface_isomer_{}'.format(i)
    a=data[i]
