...
def plot_conf(ax, atoms, rot=False):
    ...
    colors[72] = [0.1, 0.1, 0.2]
    colors[69] = [0.1, 0.2, 0.5]
    colors[73] = [0.1, 0.2, 0.5]
    colors[74] = [0.1, 0.2, 0.5]
    colors[75] = [0.1, 0.2, 0.5]
    colors[76] = [0.9, 0.3, 0.9]
    colors[77] = [0.9, 0.3, 0.9]
...
data=read('VO2H2O_TiO2_101_DFTlowlyingsorted.traj@:')
...
plt.tight_layout()
savefig('VO2_2H2O_TiO2_101_DFTopt_19th.pdf',bbox_inches='tight')
show()
