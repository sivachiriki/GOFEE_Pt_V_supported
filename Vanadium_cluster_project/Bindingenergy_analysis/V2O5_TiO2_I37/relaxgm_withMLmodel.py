...
traj = Trajectory('V2O5_TiO2_101_DFTrelaxed.traj','w')
name ='V2O5_TiO2_101surface_gm'
data = read('BE_V2O5_TiO2_101_I37.traj@:')
for i in range(0,len(data)):
    name ='V2O5_TiO2_101surface_isomer_{}'.format(i)
    a=data[i]
