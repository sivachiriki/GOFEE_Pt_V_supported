...
traj = Trajectory('2VO3Htrans_final_TiO21013by1cell2layer_DFTrelxd.traj','w')
data = read('2VO3Htrans_final_TiO21013by1cell2layer_forrollingmechanism.traj@:')
for i in range(0,len(data)):
    name ='isomer_{}'.format(i)
    a=data[i]
    a.set_calculator(calc)
    a_relaxed = relaxGPAW(a, name, forcemax=0.02, niter_max=7,steps=100)
