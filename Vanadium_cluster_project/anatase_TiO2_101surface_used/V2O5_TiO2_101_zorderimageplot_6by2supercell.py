...
data=read('TiO2_101sur_6by2cell_Ov_DFTrelaxed.traj@:')
...
for j in range(len(data)):
    ...
    ax.set_xlim([-1.0, 21.3])
    ax.set_ylim([-1.50, 22.50])
    ax.set_yticks([])
    ax.set_xticks([])
    ax.set(aspect=1)
    ...
    plt.tight_layout()
    name ='TiO2_101sur_6by2supercell.png'
