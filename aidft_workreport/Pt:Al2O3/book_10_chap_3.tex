...
\begin{figure}
  \label{fig:myfig}
\image{COEf_CO2Ef_CO3Ef_O2Ef_Pt7Oxides1.png}{width="90%"}
\caption{}
\end{figure}
\begin{figure}
  \label{fig:myfig}
\image{delta_COEf_CO2Ef_CO3Ef_O2Ef_Pt7Oxides1.png}{width="90%"}
\caption{}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
...
\begin{figure}
  \label{fig:myfig}
\image{structures_formationcurves_Pt7Oxides.png}{width="90%"}
\caption{}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
